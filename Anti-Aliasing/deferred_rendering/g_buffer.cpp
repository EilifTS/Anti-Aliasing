...
GBuffer::GBuffer(egx::Device& dev, const ema::point2D& size, float far_plane)
	...
	depth_buffer(dev, egx::TextureFormat::D32_S32, size)
{
	...
	depth_buffer.CreateShaderResourceViews(dev, egx::TextureFormat::D32_S32_Depth, egx::TextureFormat::D32_S32_Stencil);
}